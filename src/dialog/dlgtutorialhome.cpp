...
TutorialHomePage::TutorialHomePage(QWidget* parent)
    ...
    addTutorialSection(pTutorialLayout,
            ...
            {{QStringLiteral("level-zero"), QStringLiteral("01"),
                     tr("Your first mix"),
                     tr("Meet the fixed tutorial tracks, read the waveforms, press play, and move the essential faders."),
                     tr("NEON CURRENT + GLASS HORIZON · 00:08"), tr("6 MIN"), true}});
    addTutorialSection(pTutorialLayout,
            ...
            {{QStringLiteral("crossfader"), QStringLiteral("02"),
                    ...
                    tr("NEON CURRENT + GLASS HORIZON · 00:16"), tr("5 MIN"), true},
                    {QStringLiteral("channel-faders"), QStringLiteral("03"),
                            ...
                            tr("NEON CURRENT + GLASS HORIZON · 00:24"), tr("6 MIN"), true},
                    {QStringLiteral("bass-eq"), QStringLiteral("04"),
                            ...
                            tr("SOLAR CIRCUIT · 00:32"), tr("7 MIN"), true}});
    addTutorialSection(pTutorialLayout,
            ...
            {{QStringLiteral("cueing"), QStringLiteral("05"),
                     ...
                     tr("NEON CURRENT + GLASS HORIZON · 00:40"), tr("6 MIN"), true},
                    {QStringLiteral("beatmatching"), QStringLiteral("06"),
                            tr("Beat match by hand"),
                            tr("Match BPM with the tempo fader, then nudge the beat bars into line."),
                            tr("NEON CURRENT + GLASS HORIZON · 00:16"), tr("7 MIN"), true},
                    {QStringLiteral("looping"), QStringLiteral("07"),
                            ...
                            tr("SOLAR CIRCUIT · 00:48"), tr("7 MIN"), true}});
    addTutorialSection(pTutorialLayout,
            ...
            {{QStringLiteral("filter-sweep"), QStringLiteral("08"),
                     ...
                     tr("NEON CURRENT + GLASS HORIZON · 01:04"), tr("6 MIN"), true},
